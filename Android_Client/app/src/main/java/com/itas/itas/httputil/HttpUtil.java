...
public class HttpUtil {
         ...
         *
         */
        public static void judgeMAC(String url , Context context, final HttpStatusLister lister){
         ...
         */
        public static void login(String url, String passwd, final HttpStatusLister lister){
            HashMap<String,String> hashMap = new HashMap<>();
         ...
         */
        public static void sign(String url, String passwd, String userName, final HttpStatusLister lister){
            HashMap<String,String> hashMap = new HashMap<>();
