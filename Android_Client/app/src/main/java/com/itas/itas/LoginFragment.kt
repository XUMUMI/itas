...
class LoginFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        login_button.setOnClickListener {
            ...
            /********************* start 需比较的两个数据**********************/
            val userName =  login_username.text.toString() //用户名
            val userPassword = login_user_password.text.toString() //用户密码
            /*************************end **********************************/
                ...
                userPassword.isEmpty() ->  login_password?.error = resources.getString(R.string.sig_pass_blank)
                    ...
                    Thread(Runnable {
                      /********  在子线程发送一个消息。**********/
                        ...
                        /**************start 将用户名和密码与服务器比较********************/
                        /*如果服务器中存在此用户名和密码 msg.what =0 */
                        msg.what = 0

                        /*如果服务器中不存在此用户名和密码 msg.what =1 */

                        /*如果服务器连接超时 msg.what =2 */


                        /*******通讯完毕将数据发送到主线程 handler.sendMessage(msg)*************/
