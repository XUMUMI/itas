...
//    class listener: HttpStatusLister {
//
...
//    }
           ...
           // val userEmail = sign_up_user_email.text.toString().trim()
            ...
            if (userPassword == confirmPassword && confirmPassword != "") {
                ...
                Thread(Runnable {
                    ...
                    val msg = Message()
                    requestStatus = requestSuccessAble(userName,userPassword)
                    Log.d("test",requestStatus.toString())
    ...
    private fun requestSuccessAble(userName:String, userPassword:String): Int {
        ...
        HttpUtil.sign(
                "http://192.168.123.90:8080/Client/",
                userPassword,
                userName,
                listener()
        )
